...
export default function GenerateWithAiPage() {
  ...
  async function refresh() {
    ...
    setPacks(all.filter((p) => p.source === "AI"));
  }
  ...
  return (
    <div>
      <div className="page-header">
        <h1>Generate Contents with AI</h1>
      ...
      {packs.length === 0 && (
        <div className="empty-state">No AI-generated Tutor Packs yet — create one above to get started.</div>
      )}
